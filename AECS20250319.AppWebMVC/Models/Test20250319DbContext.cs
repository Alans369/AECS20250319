...
public partial class Test20250319DbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.BrandId).HasName("PK__Brands__DAD4F3BE1435088B");
        ...
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__Categori__19093A2B89C8310A");
        ...
        {
            entity.HasKey(e => e.ProductId).HasName("PK__Products__B40CC6ED2A509CF7");
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__Users__1788CCACF09BA4B8");

            entity.HasIndex(e => e.Email, "UQ__Users__A9D10534468D72D3").IsUnique();
